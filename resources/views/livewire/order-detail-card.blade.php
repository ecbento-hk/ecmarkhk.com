                              ...
                              @foreach($order->items as $item)
                                <tr>
                                    ...
                                    <td width="70%"> <span class="font-weight-bold">{{$item->product->title}}</span>
                                        <div class="product-qty"> <span class="d-block">Quantity:{{$item->quantity}}</span>@if($item->menu_date)&nbsp;&nbsp; <span class="d-block">Date:<u>{{date('Y-m-d',strtotime($item->menu_date))}}</u></span>@endif</div>
