		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主頁</a> > 入讀學科  >  高級文憑  >  <?php echo xss_chk($row['Programme_Code']); ?> - <?php echo xss_chk($row['Programme_Name_TC']); ?>
					</div>
					...
					<div class="bodyContext">
						<div class="bodyContextMain col-sm-8" >
							...
							<?php echo addRemarks(nl2br(no2ol(xss_chk($row['Programme_Features_TC'])))); ?>
							<?php
							if ($row['StreamElective_TC'] != '' && $row['StreamElective_TC'] != null){
							?>
							<br><br>
							<?php
								echo nl2br(xss_chk($row['StreamElective_TC']));
							}
							?>
							<div class="mainSubTitle">
								專業核心單元
							...
							<?php echo nl2br(xss_chk($row['Professional_Core_Modules_TC'])); ?>
							...
							<?php 
							echo nl2br(xss_chk($row['Career_Prospects_TC']));
							?>
							...
							<?php
							echo nl2br(xss_chk($row['Professional_Recognition_TC']));
							?>
							
							
							<div class="mainSubTitle">
								升讀學位課程<span class="additional">*</span>
							</div>
							
							<table> 
								<tr><th>大學</th><th>課程</th></tr>
								<tr><td><?php echo xss_chk($row['Articulation2_TC']); ?></td><td><?php echo xss_chk($row['Articulation_TC']); ?></td></tr>
								<?php
								if (isset($row['Articulation4_TC']) && isset($row['Articulation4_TC'])){
								?>
									<tr><td><?php echo xss_chk($row['Articulation4_TC']); ?></td><td><?php echo xss_chk($row['Articulation3_TC']); ?></td></tr>
						...
						<div class="bodyContextSides col-sm-4">
							...
							<div class="sideLinkBox type3" >
								<?php 
									...
									$keywordArr = explode( ',', xss_chk($row['Keyword_TC']));
							...
							<div class="sideBox" >
								...
								<div class="sideBoxTitleSubTitle2">直接入讀課程
								</div><br><br>
					...
					<div class="bodyContextAdditional col-sm-12" >
						<span>*</span>畢業生可升讀本地或海外院校提供之學位課程 ，詳情可<a href="">按此</a><br>
					</div>
				</div>
