...
<link rel="stylesheet" href="../css/international.css?v=20190724">
			...
			<div class="row">
				<div class="col mainBg">
					<div class="imageSlide">
						<img src="../images/internationalPostgraduate.jpg" />
					</div>
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主页</a> > 国际化 > <?php echo xss_htmlpurifier($title_sc); ?>
					</div>
