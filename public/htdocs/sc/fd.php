...
$sfdfs = $conn->prepare("SELECT * FROM ba_programmes_dfs");
$sfdfs->execute();
		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主页</a> > 入读学科  >  基础课程文凭
					</div>
					...
					<div class="programmeItem" >
						...
						<div class="programmeItemDetails">
							<div class="programmeItemTitle">
								<?php echo xss_chk($row['Programme_Code']); ?> <span class="programmeItemCampus"> | <?php echo xss_chk($row['Campuses']); ?></span>
							</div>
							<div class="programmeItemSubTitle">
								<?php echo xss_chk($row['Programme_Title_SC']); ?>
							</div>
							<div class="programmeItemContent">
								<?php echo xss_chk($row['Programme_Features_SC']); ?>
							</div>
							<div class="programmeItemButton">
								<a href="fdd.php?pc=<?php echo xss_chk($row['Programme_Code']); ?>">更多详情</a>
							</div>
						</div>
					</div>
						...
						<div class="bodyContextAdditional col-sm-12">
							<div class="additionalAddress">
								<?php
									...
									foreach ($location_type2 as $key => $value) {
										?>
