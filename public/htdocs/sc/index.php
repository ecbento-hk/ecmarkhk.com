...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-CG5S9WX8M9"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-CG5S9WX8M9');
</script>
			...
			<div class="row">
				<div class="col mainSlide">
					...
					<div class="imageSlide">
						<?php
								echo xss_htmlpurifier($slide_content_sc);
							?>
						<div class="imageSlideText">
							<?php
								echo xss_htmlpurifier($slideText_content_sc);
							?>
						</div>
					</div>
