...
<link rel="stylesheet" href="../css/studentScholarships.css">
			...
			<div class="row">
				<div class="col mainBg">
					<div class="imageSlide">
						<img src="../images/studentScholarships.jpg" />
					</div>
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主页</a> > 入读学科 > 学费及奖学金 > <?php echo xss_htmlpurifier($title_sc); ?>
					</div>
