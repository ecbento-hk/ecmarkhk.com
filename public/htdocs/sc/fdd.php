		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主页</a> > 入读学科  >  基础课程文凭  >  <?php echo xss_chk($row['Programme_Code']); ?> - <?php echo xss_chk($row['Programme_Title_SC']); ?>
					</div>
					...
					<div class="bodyContext">
						...
						<div class="bodyContextSides col-sm-4">
							<div class="sideLinkBox" >
								<a href="http://www.vtc.edu.hk/admission/tc/s6/application-information/degree-higher-diploma-foundation-diploma/general-entrance-requirements/">
									一般入学要求
								</a>
							</div>
							<div class="sideLinkBox type2" >
								<a href="http://maintpage.vtc.edu.hk/admission/index_ca.htm">
									现在申请!
								</a>
							</div>
