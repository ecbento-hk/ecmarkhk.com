...
<link rel="stylesheet" href="../css/awardBearingProgramme.css">
			...
			<div class="row">
				<div class="col mainBg">
					<div class="imageSlide">
						<img src="../images/continuingAboutContinuingEducation.jpg" />
					</div>
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主页</a> > 持续进修 > <?php echo xss_htmlpurifier($title_sc); ?>
					</div>
