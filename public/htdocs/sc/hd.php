		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">主页</a> > 入读学科  >  高级文凭
					</div>
			  ...
			  <ul>
				<li><a href="#category">课程类别</a></li>
				<li><a href="#location">上课地点</a></li>
				
			  </ul>
			  
			  <div id="category">
			  <div class="tab_intro">以课程类别排列</div>
				<?php
				...
				<div class="programmeList" >
					...
					<?php
						echo xss_chk($sfpc_row['Programme_Category_Name_SC']);
					?>
					</div>
							...
							<div class="programmeItem" >
								...
								<div class="programmeItemDetails">
									...
									<div class="programmeItemButton">
										<a href="hdd.php?pc=<?php echo xss_chk($row['Programme_Code']); ?>">更多详情</a>
									</div>
								</div>
							</div>
					<?php
			  ...
			  <div class="tab_intro">以地区排列</div>
				<div class="programmeList" >
					...
					foreach($location_type as $key=>$lt){
						?>
						<div class="programmeTitle" >
							<?php echo $location_type_name[$key][1]; ?>
						</div>
						<?php
						foreach($rows as $row){
