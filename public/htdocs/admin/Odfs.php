  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<?php
				$sfes = $conn->prepare("SELECT * FROM `ba_programmes_dfs`");
				$sfes->execute();
			...
			<div class="row">
				<div class="col-xl-12 col-sm-12 mb-12" >
					...
					<div class="all form-group">
						...
						<div class="form-group">
							<label class="col-sm-12 control-label">Campuses</label>
							<div class="col-sm-10">
								<input type="text" name="Campuses" class="form-control" value="" required>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-12 control-label">Hashtag</label>
							<div class="col-sm-10">
								<input type="text" name="Hashtag" class="form-control" value="">
							</div>
						</div>
					...
					<div class="programme_tabs form-group" id="programme_tabs">
						...
						<ul>
							...
							<div class="en"  id="en">
								...
								<div class="form-group">
									<label class="col-sm-12 control-label">Programme Title EN</label>
									<div class="col-sm-10">
										<input type="text" name="Programme_Title_EN" class="form-control" value="">
									</div>
								</div>
							...
							<div class="tc"  id="tc">
								...
								<div class="form-group">
									<label class="col-sm-12 control-label">Programme Title TC</label>
									<div class="col-sm-10">
										<input type="text" name="Programme_Title_TC" class="form-control" value="">
									</div>
								</div>
							...
							<div class="sc"  id="sc">
								...
								<div class="form-group">
									<label class="col-sm-12 control-label">Programme Title SC</label>
									<div class="col-sm-10">
										<input type="text" name="Programme_Title_SC" class="form-control" value="">
									</div>
								</div>
  ...
  <script>
	...
	for (var i = 0; i < data_field.length; i++){
		...
		$('#course_list').append($("<option></option>")
                    ...
                    .text(data_field[i]['Programme_Code'] + '-' + data_field[i]['Programme_Title_EN'])); 
	}
	...
	$('body').on('click', 'button.program_save', function(e) {
		...
		if ($('input[name=Programme_Code]').val() != '' && $('input[name=Campuses]').val() != '' && $('input[name=Contact_Email_Tel]').val() != ''){
	...
	$('body').on('click', 'button.add_img', function(e) {
		e.preventDefault();
		 var id = $(this).data('id');
		  window.open('upload_img.php?id='+id+'&db=ba_programmes_dfs', 'Upload Image', config='height=800,width=1000');
