...
if (isset($_POST['Mode_EN']) && !empty($_POST['Mode_EN'])){
	$Mode_EN = $_POST['Mode_EN'];
	
	$aes_check = $conn->prepare("SELECT * FROM `ba_programmes_topup` WHERE Mode_EN = :Mode_EN ");
	$aes_check->bindValue(':Mode_EN', xss_chk($Mode_EN), PDO::PARAM_STR);
	$aes_check->execute();
