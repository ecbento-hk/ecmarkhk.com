	...
	<div class="row">
		<div class="mainContent">
			<div class="row">
			  ...
			  <ul>
				<li><a href="#category">Programme Category</a></li>
				<li><a href="#location">Location</a></li>
				
			  </ul>
			  
			  <div id="category">
			  <div class="tab_intro">Find the course by programme category</div>
				<?php
				...
				<div class="programmeList" >
					...
					<?php
						echo xss_chk($sfpc_row['Programme_Category_Name']);
					?>
					</div>
							...
							<div class="programmeItem" >
								...
								<div class="programmeItemDetails">
									...
									<div class="programmeItemContent">
										<?php echo xss_chk(removeList($row['Programme_Features_EN']));
										?>
									</div>
									<div class="programmeItemButton">
										<a href="hdd.php?pc=<?php echo xss_chk($row['Programme_Code']); ?>">More Details</a>
									</div>
								</div>
							</div>
					<?php
			  ...
			  <div id="location">
			  <div class="tab_intro">Find the programme by location</div>
				<div class="programmeList" >
					<?php 
