		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">Home</a> > Study  >  Top-up Degree
					</div>
					...
					<div class="programmeItem" >
						...
						<div class="programmeItemDetails">
							...
							<div class="programmeItemButton">
								<a href="tud.php?rn=<?php echo xss_chk($row['RegNo']); ?>">More Details</a>
							</div>
			  ...
			  <!--<p>
				Note:
					<ul>
					<li>The above programmes are recognized under the Qualification Framework (QF Level 5).</li>

					<li>It is a matter of discretion for individual employers to recognise any qualification to which this course may lead.</li>
					</ul>
			  </p>-->
