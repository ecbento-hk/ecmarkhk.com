			...
			<div class="row">
				<div class="col mainBg">
					<div class="imageSlide">
						<img src="../images/continuingTrainingProgrammmesTailor-made.jpg" />
					</div>
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">Home</a> > Continuing Education > Training Programmes > <?php echo xss_htmlpurifier($title_en); ?>
					</div>
