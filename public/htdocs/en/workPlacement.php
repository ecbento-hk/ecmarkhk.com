...
<link rel="stylesheet" href="../css/main.css?v=20190817">
			...
			<div class="row">
				<div class="col mainBg">
					<div class="imageSlide">
						<img src="../images/businessAccessourStudentsWorkPlacement.jpg" />
				...
				<div class="col container mainBodyContainer">
					...
					<a href="index.php">Home</a> > Business > Access Our Students > <?php echo xss_htmlpurifier($title_en); ?>
					</div>
						...
						<div class="bodyContextMain col-sm-12" >
							...
							<div class="row" >
								<div class="col-sm-12 shortCourse" >
									...
									<br><br>
									<?php 
										define('recruitment_form', TRUE);
										require_once('recruitmentForm.php');
									?>
