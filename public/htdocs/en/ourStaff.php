		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					<div class="bodyTitle" >
					<?php echo xss_htmlpurifier($title_en); ?>
					</div>
					<div class="bodyBreadcrumbs" >
					<a href="index.php">Home</a> > About Us >  <?php echo xss_htmlpurifier($title_en); ?>
					</div>
						...
						<div class="bodyContextMain col-sm-12" >
							...
							<div class="row" >
								...
								<br>
									...
									?>
									<!--<div class="ourStaffListImg">
										<img src="../images/BA_Staff.jpg" />
										<img src="../images/StaffDetails2.jpg" />
									</div>-->
									<!--<div class="ourStaffList">
										<div class="ourStaffListItem">
											<div class="ourStaffListItemNum" >
											90
											</div>
											<div class="ourStaffListItemSymbol" >
											%+
											</div>
											<div class="ourStaffListItemTitle" >
											Teaching Staff
											</div>
											<div class="ourStaffListItemDetails" >
											Teaching Staff
											</div>
										...
										<div class="ourStaffListItem">
											...
											<div class="ourStaffListItemDetails" >
											IVE Business Discipline
											</div>
											
											
										</div>
										
										<div class="ourStaffListItem grey">
											<div class="ourStaffListItemNum" >
											1
											</div>
											<div class="ourStaffListItemSymbol" >
										...
										<div class="ourStaffListItem white">
											<div class="ourStaffListItemNum" >
											3
											</div>
											<div class="ourStaffListItemSymbol" >
								...
								<div class="sideSubMenu col-sm-3" >
									<div class="sideSubMenuTitle" >
									About Us	
									</div>
									<div class="sideSubMenuContent" >
										<ul>
											<li><a href="ourVision.php">Our Vision</a></li>
											<li><a class="active" href="#">Our Staff</a></li>
