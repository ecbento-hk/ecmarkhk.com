		...
		<div class="mainContent">
			<div class="row">
				...
				<div class="col container mainBodyContainer">
					...
					Home Study  >  Higher Diploma  >  <?php echo xss_chk($row['Programme_Code']); ?> - <?php echo xss_chk($row['Programme_Name_EN']); ?>
					</div>
					...
					<div class="bodyContext">
						<div class="bodyContextMain col-sm-8" >
							...
							<?php echo addRemarks(nl2br(no2ol(xss_chk($row['Programme_Features_EN'])))); ?>
							
							<?php
							if ($row['StreamElective_EN'] != '' && $row['StreamElective_EN'] != null){
							?>
							<br><br>
							<?php
								echo nl2br(xss_chk($row['StreamElective_EN']));
							}
							?>
							...
							<?php 
							echo nl2br(xss_chk($row['Career_Prospects_EN']));
							?>
							
							<?php
							if ($row['Professional_Recognition_EN'] != '' && $row['Professional_Recognition_EN'] != null){
							?>
							<div class="mainSubTitle">
							Professional Recognition
							</div>
							<?php
								echo addRemarks(nl2br(xss_chk($row['Professional_Recognition_EN'])));
							}
							?>
							
							
							<div class="mainSubTitle">
								2+1 International Track<span class="additional">*</span>
								<br>
								Direct Admission to Degree Programme
							</div>
							...
							<table> 
								...
								<?php
								if (isset($row['Articulation4_EN']) && isset($row['Articulation3_EN'])){
								?>
									<tr><td><?php echo xss_chk($row['Articulation4_EN']); ?></td><td><?php echo xss_chk($row['Articulation3_EN']); ?></td></tr>
						...
						<div class="bodyContextSides col-sm-4">
							...
							<div class="sideLinkBox type3" >
								<?php 
									function keywordAction($n){
										return("<span class='keyword'>#" . $n . "</span>");
									};
									$keywordArr = explode( ',', xss_chk($row['Keyword_EN']));
							...
							<div class="sideBox" >
								<div class="sideBoxTitle">
									Higher Diploma to Degree
								</div>
								<div class="sideBoxTitleSubTitle2">Direct Admission Programme
								</div><br><br>
					...
					<div class="bodyContextAdditional col-sm-12" >
						<span>*</span>Graduates opting for further studies could be admitted to the degree programmes offered by various local and overseas institutions. Please <a href="">click here</a> to learn more.
					</div>
				</div>
